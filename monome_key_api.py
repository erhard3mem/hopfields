...
class GridStudies(monome.GridApp):
    ...
    async def play(self):        
        # read images
       # i = Image.open('train_directory/computer_in_network.png')
        i = Image.open('train_directory/empty_houses.png')
        rawData = np.asarray(i)    
    ...
    def trigger(self, i):
        print("triggered", i)
        subprocess.Popen(['mpg123', '-q', '/home/erhard/web/monomegrid/s2/'+str(i)+'.mp3'])#.wait()
